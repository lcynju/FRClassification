...
public class ActiveProcessPseudoDuplicate {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String fileFolder = "D:\\Experiments-0724-Fold1\\active learning pseudo\\";
		...
		for (String featureName : featureNames) {
			...
			for (String type : types) {
				String curveFile = fileFolder + "dup-pseudo-" + type + "-" + featureName + "-curve.txt";
